      ...
      <div className="relative bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
            ...
            <nav className="hidden md:flex space-x-10">
              <div className="relative">
                ...
                <button
                  ...
                  "
                  onClick={() => (this.setState({flyer: !this.state.flyer}), this.setState({flyerTwo: false}))}
                >
                  <span>Solutions</span>
                  {/*
          ...
          */}
                ...
                <div
                  onMouseLeave={() => this.setState({flyer: false})}
                  className={
                    this.state.flyer
              ...
              <div className="relative">
                ...
                <button
                  ...
                  onClick={() => (this.setState({flyerTwo: !this.state.flyerTwo}), this.setState({flyer: false}))}
                >
                  <span>More</span>
                  {/*
              Heroicon name: solid/chevron-down
          ...
          */}{" "}
                <div
                  onMouseLeave={() => this.setState({flyerTwo: false})}
                  className={
                    this.state.flyerTwo
                      ? " opacity-100 translate-y-0 transition ease-out duration-200 absolute z-10 -ml-4 mt-3 transform px-2 w-screen max-w-md sm:px-0 lg:ml-0 lg:left-1/2 lg:-translate-x-1/2"
                      : " opacity-0 translate-y-1 absolute z-10 -ml-4 mt-3 transform px-2 w-screen max-w-md sm:px-0 lg:ml-0 lg:left-1/2 lg:-translate-x-1/2"
